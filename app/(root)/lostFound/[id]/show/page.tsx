    ...
    <div className="rounded-lg bg-gray-50 px-16 py-14">
      <div className="flex justify-center">
        <div className="rounded-full bg-blue-200 p-6">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-500 p-4">
            <svg
        ...
        >
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-none lg:w-[175px] flex flex-col gap-8">
              {/* Funds Raised Card */}
              <Card className=" border border-blue-500 p-2 rounded-lg shadow-lg">
                <CardHeader>
                  <CardTitle className="text-center text-lg">
                    Funds Raised
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center text-lg font-bold text-blue-500">
              ...
              <Card className=" border border-blue-500 p-2 rounded-lg shadow-lg">
                ...
                <CardContent className="text-center text-lg font-semibold text-blue-500">
          ...
          <div className="mt-8 flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-none lg:w-[350px]">
              <Card className=" border border-blue-500 p-4 rounded-lg shadow-lg">
                <CardHeader>
                  <CardTitle className="text-center text-lg font-ibm-plex-sans">
                    Fund This Campaign
                  </CardTitle>
                ...
                <CardContent>
                  ...
                  <Button
                    ...
                    className="bg-blue-500 text-white px-6 py-3 w-full"
                  >
                    Fund Now
                  </Button>
                </CardContent>
